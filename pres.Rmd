...
Pythagoras and his followers believed that the basis of the universe and everything in it are numbers. This idea is not so different from the Milesian idea, since it still agrees that the universe is made from only one substance, but in Pythagoras case he replaces the substance with a form. [@dk_philosophy_2017]
